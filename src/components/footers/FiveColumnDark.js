...
import LogoImage from "images/JMA_logo1.jpg";
        ...
        <FiveColumns>
          <CompanyColumn>
            ...
            <SocialLinksContainer>
              <SocialLink href="https://www.facebook.com/jmardg/" target="_blank">
                <FacebookIcon />
              </SocialLink>
              <SocialLink href="https://x.com/jmardg" target="_blank">
                <TwitterIcon />
              </SocialLink>
              <SocialLink href="https://www.youtube.com/@JMARDG" target="_blank">
                <YoutubeIcon />
              </SocialLink>
            </SocialLinksContainer>
          </CompanyColumn>
